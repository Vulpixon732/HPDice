...
static struct FScriptStruct_SnapSystem_StaticRegisterNativesFCopySockets
{
	...
	{
		UScriptStruct::DeferCppStructOps<FCopySockets>(FName(TEXT("CopySockets")));
	}
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FCopySockets_Statics::NewProp_Sockets = { "Sockets", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCopySockets, Sockets), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FCopySockets_Statics::NewProp_Sockets_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCopySockets_Statics::NewProp_Sockets_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FCopySockets_Hash() { return 3795069083U; }
...
static struct FScriptStruct_SnapSystem_StaticRegisterNativesFExportSocket
{
	...
	{
		UScriptStruct::DeferCppStructOps<FExportSocket>(FName(TEXT("ExportSocket")));
	}
	...
	uint32 Get_Z_Construct_UScriptStruct_FExportSocket_Hash() { return 601797880U; }
	...
	IMPLEMENT_CLASS(UCopyPasteSockets, 307995464);
