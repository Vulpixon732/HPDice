...
void EmptyLinkFunctionForGeneratedCodeAutoSettings_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_AutoSettings()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_AutoSettings_IntCVarChangedEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AutoSettings_BoolCVarChangedEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AutoSettings_FloatCVarChangedEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AutoSettings_StringCVarChangedEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AutoSettings_IntCVarChangedSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AutoSettings_BoolCVarChangedSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AutoSettings_FloatCVarChangedSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AutoSettings_StringCVarChangedSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AutoSettings_OnSettingSaved__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AutoSettings_RadioSelectedSignature__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_AutoSettings_SpinnerSelectionChanged__DelegateSignature,
			};
