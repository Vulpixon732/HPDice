...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UInputLabel_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UInputLabel_MappingsChanged, "MappingsChanged" }, // 3308196245
		{ &Z_Construct_UFunction_UInputLabel_UpdateLabel, "UpdateLabel" }, // 1220450655
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UInputLabel, 1589729951);
	template<> AUTOSETTINGSINPUT_API UClass* StaticClass<UInputLabel>()
	{
		return UInputLabel::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UInputLabel(Z_Construct_UClass_UInputLabel, &UInputLabel::StaticClass, TEXT("/Script/AutoSettingsInput"), TEXT("UInputLabel"), false, nullptr, nullptr, nullptr);
