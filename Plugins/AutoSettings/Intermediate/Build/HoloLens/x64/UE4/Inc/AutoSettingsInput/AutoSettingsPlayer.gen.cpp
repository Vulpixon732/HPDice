...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UAutoSettingsPlayer_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UAutoSettingsPlayer_GetDefaultInputMappingPreset, "GetDefaultInputMappingPreset" }, // 3020268341
		{ &Z_Construct_UFunction_UAutoSettingsPlayer_GetInputMappings, "GetInputMappings" }, // 1182707474
		{ &Z_Construct_UFunction_UAutoSettingsPlayer_GetUniquePlayerIdentifier, "GetUniquePlayerIdentifier" }, // 1852938602
		{ &Z_Construct_UFunction_UAutoSettingsPlayer_SaveInputMappings, "SaveInputMappings" }, // 2941024220
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UAutoSettingsPlayer, 2514699240);
	template<> AUTOSETTINGSINPUT_API UClass* StaticClass<UAutoSettingsPlayer>()
	{
		return UAutoSettingsPlayer::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAutoSettingsPlayer(Z_Construct_UClass_UAutoSettingsPlayer, &UAutoSettingsPlayer::StaticClass, TEXT("/Script/AutoSettingsInput"), TEXT("UAutoSettingsPlayer"), false, nullptr, nullptr, nullptr);
