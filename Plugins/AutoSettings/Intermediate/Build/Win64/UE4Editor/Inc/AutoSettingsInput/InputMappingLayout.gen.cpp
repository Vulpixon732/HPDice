...
class UScriptStruct* FInputMappingLayout::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern AUTOSETTINGSINPUT_API uint32 Get_Z_Construct_UScriptStruct_FInputMappingLayout_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FInputMappingLayout, Z_Construct_UPackage__Script_AutoSettingsInput(), TEXT("InputMappingLayout"), sizeof(FInputMappingLayout), Get_Z_Construct_UScriptStruct_FInputMappingLayout_Hash());
	}
	return Singleton;
}
...
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FInputMappingLayout(FInputMappingLayout::StaticStruct, TEXT("/Script/AutoSettingsInput"), TEXT("InputMappingLayout"), false, nullptr, nullptr);
static struct FScriptStruct_AutoSettingsInput_StaticRegisterNativesFInputMappingLayout
{
	FScriptStruct_AutoSettingsInput_StaticRegisterNativesFInputMappingLayout()
	{
		UScriptStruct::DeferCppStructOps<FInputMappingLayout>(FName(TEXT("InputMappingLayout")));
	}
} ScriptStruct_AutoSettingsInput_StaticRegisterNativesFInputMappingLayout;
	...
	uint32 Get_Z_Construct_UScriptStruct_FInputMappingLayout_Hash() { return 152440087U; }
